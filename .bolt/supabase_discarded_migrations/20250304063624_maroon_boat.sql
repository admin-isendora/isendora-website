/*
  # Seed voice assistants data

  1. Inserts initial voice assistants data:
    - AI Receptionist (Female, American)
    - AI Support Agent (Male, British)
    - AI Booking Assistant (Female, Australian)
*/
